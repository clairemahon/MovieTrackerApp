...
class CustomDropdownMediaItem<T> extends PopupMenuEntry<T> {
  ...
  @override
  State<CustomDropdownMediaItem<T>> createState() =>
      _CustomDropdownMediaItemState<T>();
...
class _CustomDropdownMediaItemState<T>
    extends State<CustomDropdownMediaItem<T>> {
  @override
